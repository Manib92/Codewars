...
His mother looks out of a window 1.5 meters from the ground. How many times will
the mother see the ball pass in front of her window (including when it's falling
and bouncing?
...
Note: The ball can only be seen if the height of the rebounding ball is strictly
